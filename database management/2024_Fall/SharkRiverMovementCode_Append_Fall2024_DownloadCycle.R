...
### Mack added this to aboce code chunk for ease
...
HeithausVUE_Distance <- RehageVUE_Distance |> filter(is.na(Species))
saveRDS(HeithausVUE_Distance, "database management/2024_Fall/RDS_files/HeithausVUE_All_12192024_wDISTANCE.rds")
